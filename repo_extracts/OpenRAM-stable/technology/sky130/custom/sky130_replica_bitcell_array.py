...
# #region debug-point EA:sky130-replica-array-report-event
...
class sky130_replica_bitcell_array(replica_bitcell_array, sky130_bitcell_base_array):
    ...
    def __init__(self, rows, cols, rbl=None, left_rbl=None, right_rbl=None, name=""):
        # #region debug-point EB:ctor-enter
        _dbg_report("EB", "technology/sky130/custom/sky130_replica_bitcell_array.py:ctor_enter", "[DEBUG] sky130_replica_bitcell_array ctor enter", {"rows": rows, "cols": cols})
        # #endregion
        ...
        # #region debug-point EC:before-super
        _dbg_report("EC", "technology/sky130/custom/sky130_replica_bitcell_array.py:before_super", "[DEBUG] before super().__init__", {"row_size": self.row_size, "col_size": self.column_size, "rbl": self.rbl, "left_rbl": self.left_rbl, "right_rbl": self.right_rbl})
        # #endregion
        super().__init__(self.row_size, self.column_size, rbl, left_rbl, right_rbl, name)
        # #region debug-point ED:after-super
        _dbg_report("ED", "technology/sky130/custom/sky130_replica_bitcell_array.py:after_super", "[DEBUG] after super().__init__", {"name": getattr(self, "name", None)})
        # #endregion
