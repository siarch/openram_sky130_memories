...
# #region debug-point DA:sky130-capped-array-report-event
...
class sky130_capped_replica_bitcell_array(sky130_bitcell_base_array):
    ...
    def __init__(self, rows, cols, rbl=None, left_rbl=None, right_rbl=None, name=""):
        # #region debug-point DB:ctor-enter
        _dbg_report("DB", "technology/sky130/custom/sky130_capped_replica_bitcell_array.py:ctor_enter", "[DEBUG] sky130_capped_replica_bitcell_array ctor enter", {"rows": rows, "cols": cols})
        # #endregion
        ...
        # #region debug-point DC:before-create-netlist
        _dbg_report("DC", "technology/sky130/custom/sky130_capped_replica_bitcell_array.py:before_create_netlist", "[DEBUG] before create_netlist()", {"name": self.name})
        # #endregion
        self.create_netlist()
        # #region debug-point DD:after-create-netlist
        _dbg_report("DD", "technology/sky130/custom/sky130_capped_replica_bitcell_array.py:after_create_netlist", "[DEBUG] after create_netlist()", {"name": self.name})
        # #endregion
    ...
    def add_modules(self):
        # #region debug-point DE:before-replica-array-create
        _dbg_report("DE", "technology/sky130/custom/sky130_capped_replica_bitcell_array.py:before_replica_array", "[DEBUG] before replica_bitcell_array create", {"cols": self.column_size, "rows": self.row_size})
        # #endregion
        ...
        # #region debug-point DF:after-replica-array-create
        _dbg_report("DF", "technology/sky130/custom/sky130_capped_replica_bitcell_array.py:after_replica_array", "[DEBUG] after replica_bitcell_array create", {"replica": getattr(self.replica_bitcell_array, "name", None)})
        # #endregion
